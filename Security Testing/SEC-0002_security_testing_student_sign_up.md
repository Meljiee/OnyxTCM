...
| 5   | Wait for the registration to complete.                                                                  | Verify the user is redirected to the `/home` dashboard or prompted to verify their email via a Supabase auth link, depending on system settings. |
