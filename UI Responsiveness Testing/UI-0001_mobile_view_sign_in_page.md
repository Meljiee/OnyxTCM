...
| 3   | Observe the topmost section of the mobile layout screen.                                                                                 | Verify that the **Queuely logo text and icon dynamically will be removed and only the `Welcome Back` input form card remains**.     |
